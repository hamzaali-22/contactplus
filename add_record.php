<?php session_start(); ?>
<?php include '_assets/config/guard.php'; ?>
    ...
    <td align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="960" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <form id="add_contacts" name="add_contacts" method="post" action="store_record.php" onsubmit="return validateForm()">
          
          <table width="300" border="0" cellspacing="2" cellpadding="2">
          
          <tr class="labels">
            <td nowrap="nowrap">Fullname:</td>
            <td nowrap="nowrap"><input type="text" name="fullname" id="fullname" class="textFields" style="outline: none;" /></td>
          </tr>
          ...
          <tr class="labels">
            ...
            <td nowrap="nowrap"><input type="text" name="company" id="company" class="textFields" style="outline: none;"/></td>
          </tr>
          <tr><td colspan="2"><span id="companyError" style="color:red; padding-left: 75px;"></span></td></tr>

          <tr class="labels">
            <td nowrap="nowrap">Designation:</td>
            <td nowrap="nowrap"><input type="text" name="designation" id="designation" class="textFields" style="outline: none;"/></td>
          </tr>
          <tr><td colspan="2"><span id="designationError" style="color:red;    padding-left: 75px;"></span></td></tr>

          <tr class="labels">
            <td nowrap="nowrap">Phone</td>
            <td nowrap="nowrap"><input type="text" name="phone" id="phone" class="textFields" style="outline: none;"/></td>
          </tr>
          <tr><td colspan="2"><span id="phoneError" style="color:red;    padding-left: 75px;"></span></td></tr>

          <tr class="labels">
            <td nowrap="nowrap">Mobile</td>
            <td nowrap="nowrap"><input type="text" name="mobile" id="mobile" class="textFields" style="outline: none;"/></td>
          </tr>
          <tr><td colspan="2"><span id="mobileError" style="color:red;    padding-left: 75px;"></span></td></tr>

          <tr class="labels">
            <td nowrap="nowrap">Email</td>
            <td nowrap="nowrap"><input type="email" name="email" id="email" class="textFields" style="outline: none;" /></td>
          </tr>
            ...
            <td nowrap="nowrap">
                <select name="cp_group" id="cp_group" class="textFields" style="outline: none;">
                    ...
                    <?php 
                      ...
                      ?>
                    <option value="<?php echo $viewgroup['id']; ?>"><?php echo $viewgroup['title']; ?></option>
          ...
          <tr class="labels">
            ...
            <td nowrap="nowrap"><textarea name="address" id="address" cols="39" rows="5" style="outline: none;  color : #207ce5; "></textarea></td>
          </tr>
