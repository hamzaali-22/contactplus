    ...
    <td align="center"><table width="960" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="960" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <form name ="register_form" id ="register_form" method = "post" action="store_register.php">

		      <table width="300" border="0" cellspacing="2" cellpadding="2">
            <tr class="labels">
              <td nowrap="nowrap">Fullname:</td>
              <td nowrap="nowrap"><label for="tbFN"></label>
                <input type="text" name="fullname" id="fullname" class="textFields"  style="outline: none;" /></td>
            </tr>
            ...
            <tr class="labels">
              ...
              <td nowrap="nowrap">
                ...
                <div class="g-recaptcha" data-sitekey="6Lc9ENkqAAAAAOGYrubWan0Humm9T-4iO71d58SO"></div>
            ...
            <tr>
              ...
              <td align="right"><input type="submit" name="button" id="button" value="Register" class="btns" />
                <input type="submit" name="button2" id="button2" value="Cancel" class="btns" /></td>
            </tr>
      </table>
      	</td>
